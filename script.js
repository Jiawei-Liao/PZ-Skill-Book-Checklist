document.addEventListener('DOMContentLoaded', function () {
    ...
    let data = [
        ...
        { text: 'FirstAid Vol. 1', checked: false },
        { text: 'FirstAid Vol. 2', checked: false },
        { text: 'FirstAid Vol. 3', checked: false },
        { text: 'FirstAid Vol. 4', checked: false },
        { text: 'FirstAid Vol. 5', checked: false },
